const preguntas = [
    {
        pregunta: "¿Quién pintó la famosa obra 'La Persistencia de la Memoria'?",
        respuestas: ["Pablo Picasso", "Vicent van Gogh", "Salvador Dalí", "Claude Monet"],
        correcta: 2
    },
    {
        pregunta: "¿En qué ciudad puedes encontrar la famosa escultura de 'La Sirenita'?",
        respuestas: ["Londres", "París", "Roma", "Copenhague"],
        correcta: 3
    },
    {
        pregunta: "¿Cuál es el nombre de la obra más famosa de Vincent van Gogh?",
        respuestas: ["Los Girasoles", "La Noche Estrellada", "La Última Cena", "Guernica"],
        correcta: 1
    }
